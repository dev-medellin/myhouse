$(document).ready(function(){
    ...
    $('.insertProject').on('click', function(e){
        ...
        switch(modals){
            ...
            case "contructor":
                window.location.href = `${base_url}/contructor/contructor/create` 
            break;
...
$('#projInserForm').on('submit', function(event){
    ...
    var   pathUrl            = base_url+"/contructor/projects/create",
      method            	 = "POST",
      dtype 	             = "json",
...
var     pathUrl              = base_url+"/contructor/projects/edit",
        method            	 = "POST",
        dtype 	             = "json",
        rdata 	             = {projID:id};
    ...
    $.ajax({
        ...
        success: function(response){ 
            if(response.status == "SUCCESS"){
                window.location.href = base_url+"/contructor/projects/edit/"+response.data.slug;
            }else{
                window.location.href = base_url+"/contructor/projects";
            }
        }
    });
});

$('#profileContruct').on('submit', function(e){
    e.preventDefault();
    var formData = new FormData(this);

    var   pathUrl            = base_url+"/contructor/projects/update/profile",
    method            	 = "POST",
    dtype 	             = "json",
    rdata 	             = formData; 
        ...
        success: function(response){  
            if(response.status == "SUCCESS"){
                $.toast({
                    ...
                    text: 'Company Changes are applied on live site!',
...
$('#EditProForm').on('submit',function(e){
   e.preventDefault();
        if ($('#summernoteExample').summernote('isEmpty')){
            ...
            var   pathUrl            = base_url+"/contructor/projects/update",
            method            	 = "POST",
            dtype 	             = "json",
            rdata 	             = form; 
...
$('#statusBTN').on('click',function(e){
    ...
    var     pathUrl          = base_url+"/contructor/projects/status",
        method            	 = "POST",
        dtype 	             = "json",
...
$('.btnImgDel').on('click', function(e){
    ...
    swal({
        ...
        if (result) {
                ...
                var     pathUrl          = base_url+"/contructor/projects/delete/image",
                    method            	 = "POST",
                    dtype 	             = "json",
...
$('#myfile').change(function(evt) {
    ...
    swal({
        ...
        if (result) {
            ...
            var     pathUrl          = base_url+"/contructor/projects/update/image",
                method            	 = "POST",
                dtype 	             = "json",
                rdata 	             = formData;
...
$('#editInfoProj').on('submit', function(e){
    ...
    var   pathUrl            = base_url+"/contructor/projects/update/info",
    method            	 = "POST",
    dtype 	             = "json",
    rdata 	             = formData; 
...
function postStatusTeti(status){
    const myJSON = JSON.stringify(btn_approved);
    const myObj = JSON.parse(myJSON);
    var pathUrl              = base_url+"/contructor/testimony/status",
    method            	 = "POST",
    dtype 	             = "json",
...
$('#save_btn').on('click',function(){
 ...
 $('#forms-edit').on('submit',function(e){
    ...
    var   pathUrl               = base_url+"/contructor/users/update",
    method            	 = "POST",
    dtype 	             = "json",
    rdata 	             = $(this).serialize(); 
