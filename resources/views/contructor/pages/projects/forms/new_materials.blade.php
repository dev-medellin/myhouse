                            ...
                            <div class="mb-3 form-group" id="<?php echo 'removeclass'.$data['materials'][$key]['id']?>">
                                ...
                                <div class="mb-3 form-group removeData6">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-4"><label>Material</label><input class="form-control materials_title featurematerials" data-id="6" data-mat="3" value="{{$value['attributes_materials'][$key_attr]['material_kind']}}" required="" /></div>
                                        <div class="col-4"><label>Price</label><input class="form-control materials_price featurematerials" data-id="6" data-mat="3" value="{{$value['attributes_materials'][$key_attr]['price']}}" required="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" /></div>
                                        <div class="col-4">
                                            <label>Quantity</label><input class="form-control materials_quantity featurematerials" data-id="6" data-mat="3" value="{{$value['attributes_materials'][$key_attr]['quantity']}}" required="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
