...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <li class="nav-item ">
        ...
        <ul class="nav flex-column sub-menu">
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/accordions.html">Accordions</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/buttons.html">Buttons</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/badges.html">Badges</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/breadcrumbs.html">Breadcrumbs</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/dropdowns.html">Dropdowns</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/modals.html">Modals</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/progress-bar.html">Progress Bar</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/pagination.html">Pagination</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/tabs.html">Tabs</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/typography.html">Typography</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="basic-ui/tooltips.html">Tooltips</a>
            </li>
        </ul>
        </div>
    </li>
    <li class="nav-item ">
        ...
        <ul class="nav flex-column sub-menu">
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/dragula.html">Dragula</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/clipboard.html">Clipboard</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/context-menu.html">Context Menu</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/popups.html">Popups</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/sliders.html">Sliders</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/carousel.html">Carousel</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/loaders.html">Loaders</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="advanced-ui/tree-view.html">Tree View</a>
            </li>
        </ul>
        </div>
    </li>
    <li class="nav-item  ">
        ...
        <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item ">
            <a class="nav-link" href="forms/advanced-elements.html">Advanced Elements</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="forms/form-validation.html">Validation</a>
            </li>
            <li class="nav-item ">
    ...
    <li class="nav-item ">
        ...
        <ul class="nav flex-column sub-menu">
            <li class="nav-item ">
            <a class="nav-link" href="editors/text-editor.html">Text Editor</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="editors/code-editor.html">Code Editor</a>
            </li>
        </ul>
        </div>
    </li>
    <li class="nav-item  ">
        ...
        <ul class="nav flex-column sub-menu">
            <li class="nav-item ">
            <a class="nav-link" href="charts/chartjs.html">Chart Js</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/morris.html">Morris</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/flot.html">Flot</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/google-charts.html">Google Charts</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/sparklinejs.html">Sparkline Js</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/c3-charts.html">C3 Charts</a>
            </li>
            <li class="nav-item ">
            <a class="nav-link" href="charts/chartist.html">Chartist</a>
            </li>
            <li class="nav-item ">
