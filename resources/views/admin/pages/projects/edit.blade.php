    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-pills nav-pills-success" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-materials-tab" data-toggle="pill" href="#pills-materials" role="tab" aria-controls="pills-materials" aria-selected="true">Materials</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="pills-tabContent" style="padding: 0% !important;max-height :800px;min-height :800px; overflow:auto">
                <div class="tab-pane fade show active" id="pills-materials" role="tabpanel" aria-labelledby="pills-materials-tab">
                    <div class="media">
                        <div class="media-body">
                            @include('admin.pages.projects.form_materials')
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-image" role="tabpanel" aria-labelledby="pills-image-tab">
                    <div class="media">
                    <div class="media-body">
                        @include('admin.pages.projects.image_upload')
                    </div>
                    </div>
                </div>
            </div>
