<div class="card">
    ...
    <div class="modal-dialog modal-sm" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title text-danger">Contractor Application</h5>
    ...
    <div class="row">
        ...
        <div class="table-responsive">
            ...
            <table id="order-listing" class="table">
                ...
                <tbody>
                @foreach($data['contructors']['pending'] as $testi)
                <tr>
                    <td>{{ $testi->id;}}</td>
                    ...
                    <td><a href="javascript:void(0);" id="approveBtn" data-id="{{$testi}}"><i class="fa fa-edit"></i> Update</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
